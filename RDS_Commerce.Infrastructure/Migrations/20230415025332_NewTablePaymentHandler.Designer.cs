...
namespace RDSCommerce.Infrastructure.Migrations
{
    ...
    [Migration("20230415025332_NewTablePaymentHandler")]
    partial class NewTablePaymentHandler
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RDS_Commerce.Domain.Entities.PaymentHandler", b =>
                {
                    b.Property<int>("PaymentHanlderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("id_paymentHandler");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PaymentHanlderId"));
                    ...
                    b.HasKey("PaymentHanlderId");

                    b.ToTable("PaymentHandler", "RDS");
                });
