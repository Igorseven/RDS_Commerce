...
using RDS_Commerce.UnitTest.Services.GenusCommandServiceUnitTest.Base;
using RDS_Commerce.UnitTest.Tools;

namespace RDS_Commerce.UnitTest.Services.GenusCommandServiceUnitTest;
public class CreateNewGenusAsyncMethodUnitTest : GenusServiceBaseUnitTest
{
    ...
    public async Task CreateNewGenusAsync_PerfectSetting_ReturnTrue(GenusDtoForRegister genusSaveRequest)
    {
        ...
        var serviceResult = await _genusCommandService.CreateNewGenusAsync(genusSaveRequest);
